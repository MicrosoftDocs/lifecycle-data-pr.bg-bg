...
## <a name="export-products-by-end-of-support-year"></a>Експортиране на продукти в края на годината на поддръжката
Изберете година, за да експортирате продуктите, които прекратяват услугата през тази година:
