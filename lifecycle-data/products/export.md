...
ms.locfileid: "943096"
---
# <a name="lifecycle-data-export"></a><span data-ttu-id="3019a-103">Експортиране на данни за жизнен цикъл</span><span class="sxs-lookup"><span data-stu-id="3019a-103">Lifecycle data export</span></span>

> [!IMPORTANT]
> <span data-ttu-id="3019a-104">Тази страница е в процес на разработване.</span><span class="sxs-lookup"><span data-stu-id="3019a-104">This page is under development.</span></span>

## <a name="export-all-products"></a><span data-ttu-id="3019a-105">Експортиране на всички продукти</span><span class="sxs-lookup"><span data-stu-id="3019a-105">Export all products</span></span>
<span data-ttu-id="3019a-106">Експортиране на данни за жизнен цикъл за всички продукти чрез щракване по-долу:</span><span class="sxs-lookup"><span data-stu-id="3019a-106">Export lifecycle data for all products by clicking below:</span></span>

> [!div class="nextstepaction"]
> [<span data-ttu-id="3019a-107">Експортиране на всички продукти</span><span class="sxs-lookup"><span data-stu-id="3019a-107">Export All Products</span></span>](https://app-omaha-dev.azurewebsites.net/api/PublishedListings/Export)

## <a name="export-products-by-family-and-group"></a><span data-ttu-id="3019a-108">Експортиране на продукти по семейството и групата</span><span class="sxs-lookup"><span data-stu-id="3019a-108">Export products by Family and Group</span></span>
<span data-ttu-id="3019a-109">Изберете семейство и след това група за експортиране.</span><span class="sxs-lookup"><span data-stu-id="3019a-109">Select a Family and then a Group to export.</span></span> <span data-ttu-id="3019a-110">Забележка: експортирането ще започне, когато е избрана стойност на групата.</span><span class="sxs-lookup"><span data-stu-id="3019a-110">Note: Export will begin when Group value is selected.</span></span> 
...
## <a name="export-products-by-end-of-support-date"></a><span data-ttu-id="3019a-171">Експортиране на продукти по дата на края на поддръжката</span><span class="sxs-lookup"><span data-stu-id="3019a-171">Export products by end of support date</span></span>
<span data-ttu-id="3019a-172">Изберете година, за да видите продуктите, достигащи края на поддръжката.</span><span class="sxs-lookup"><span data-stu-id="3019a-172">Select a year to see products reaching the end of support.</span></span> <span data-ttu-id="3019a-173">Забележка: експортирането ще започне, когато се избере стойност за годината.</span><span class="sxs-lookup"><span data-stu-id="3019a-173">Note: Export will begin when Year value is selected.</span></span>
